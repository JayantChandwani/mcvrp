...
int main(int argc, char** argv) {
    ...
    std::vector<int> ids = mcvrp::ca::utils::parse_dataset_selection(datasets_raw);
    ...
    mcvrp::ca::utils::parallel_for(0, static_cast<int>(ids.size()), ncpus, [&](int i) {
    ...
    mcvrp::ca::utils::write_results("ca_ilp", scenario, results, datasets);
